    ...
    <b-card style="max-width: 60rem;border:4px solid #D1CACA;" class="mx-auto ">
      <b-row>
        ...
        <div class="col-md-6" style="text-align: left;">
          ...
          <div>
            <p> <b> DOB : </b>{{userList.dateOfBirth}}</p>
          </div>
          <div>
      ...
      <div id="image" style="display:none;">
        <div class="container" style="padding:2%;">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="Interests" v-model="Interests" placeholder="Enter Interests">
          </div>
          <div class="form-group">
            <label for="DOB">DOB</label>
            <br>
            <input type="date" placeholder="Enter DOB" class="form-control" v-model="DOB" id="DOB" rows="3">
          </div>
          <div class="form-group">
    ...
    methods: {
      ...
      myFunction1(id, ab, name) {
        ...
        if(myImageUrl==null||this.Interests==""||this.DOB==""){
          ...
          this.Interests=this.userList.interest;
          this.DOB=this.userList.dateOfBirth;
        }
        console.log(id);
        fetch("http://10.177.7.124:8081/userProfile/updateUser/" + id, {
          method: "PUT",
          headers: {

<template>
    <div style="margin-top:7%;">
        <b-card style="max-width: 60rem;border:4px solid #D1CACA;" class="mx-auto ">
            <b-img rounded="circle" thumbnail fluid :src="userList.userImageURL" />
        ...
        methods: {
            follow() {
                fetch("http://10.177.7.124:8081/follow/add", {
                    ...
                    body: JSON.stringify({ userId: this.name.userId, followerId: "20ed6f87-9799-48da-ac39-83df54f56329" })
                })
                    .then(function (res) {
